...
//.HttpContext.GetTokenAsync(OpenIdConnectParameterNames.AccessToken);
            ...
            {
                //this means: give access to the bearer of this token
       ...
       // This method will be responsible for returning a non expired acces token
        public async Task<string> GetAccessTokenAsync()
        {
            ...
            //If the access token dos not expires in 60 seconds or less
